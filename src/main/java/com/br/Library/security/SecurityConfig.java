...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .requestMatchers(HttpMethod.GET, "client/online/**").hasRole("CLIENT")
                .requestMatchers(HttpMethod.POST, "client/online/**").hasRole("CLIENT")
                .requestMatchers(HttpMethod.PUT, "client/online/**").hasRole("CLIENT")
                .requestMatchers(HttpMethod.DELETE, "client/online/**").hasRole("CLIENT")
